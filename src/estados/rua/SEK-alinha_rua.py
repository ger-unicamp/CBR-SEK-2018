...
def main(): #TESTES
	...
	if (colors[SensorCorDir.value()] != 'white') or (colors[SensorCorEsq.value()] != 'white'): #Condição de saída de pista
		...
		elif (colors[SensorCorDir.value()] == 'red') or (colors[SensorCorEsq.value()] =='red'): #interssecção vermelha
			sleep(0.2) #Sleep de garantia de condição
			if (colors[SensorCorDir.value()] == 'red') and (colors[SensorCorEsq.value()] =='red'):
				alinha()
				exit()
		elif (colors[SensorCorDir.value()] == 'green') or (colors[SensorCorEsq.value()] =='green'): #interssecção verde
			sleep(0.2) #Sleep de garantia de condição
